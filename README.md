...
DevDesk-RAG v2.3.0은 **통합된 고급 검색 시스템**을 제공합니다. 모든 고급 검색 관련 기능을 하나의 패키지에서 관리하여 사용자 경험과 개발 효율성을 극대화합니다.
...
### **v2.3.0 - Phase 2.4 DoRA/DoLA 시스템** ✅ **완료**
...
**DevDesk-RAG v2.3.0** - 나만의 ChatGPT를 만들어보세요! 🚀
